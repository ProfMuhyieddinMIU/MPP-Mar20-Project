...
public class AdminController implements AdminControllerInterface
{
	 ...
	 * @throws MemberInvalidDataException When the data is not received in the expected format
	 */
	public void editMember(String memberID, String firstName, String lastName, String telephone, String email, String street,
			String state, String city, String zip) throws MemberInvalidDataException, MemberNotFoundException
	{
		DataAccess da = new DataAccessFacade();
